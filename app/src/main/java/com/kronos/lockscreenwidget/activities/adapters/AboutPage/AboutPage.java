package com.kronos.lockscreenwidget.activities.adapters.AboutPage;
...
public class AboutPage {
    ...
    public AboutPage addWebsite(String url, String title) {
        ...
        websiteElement.setIconTint(R.color.colorAccent);
        websiteElement.setIconNightTint(R.color.colorAccent);
