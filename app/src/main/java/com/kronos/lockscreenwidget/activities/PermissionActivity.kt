...
//todo ver como crear burbujas de notificacion y llamar el metodo desde el switch
//todo el switch si ya tengo el permiso ponerlo visible, sino ocultarlo
class PermissionActivity : AppCompatActivity() {

    lateinit var switcherPermission: Switch
    lateinit var switcherAddBubble: Switch
    ...
    fun init(){
        ...
        switcherAddBubble = findViewById(R.id.swicht_add_bubble)
        ...
        imageBtnAbout.setOnClickListener{view -> GeneralUtilities().navigate(this,AboutActivity::class.java)}
    }
